...
class MockDependencyUseCaseWithAlternativeResolvers {
    ...
    static let uniqueResolver = Resolver()
    ...
    @SingletonDependency(resolver: MockDependencyUseCaseWithAlternativeResolvers.singletionResolver) var mockSingletonDependency: MockDependencyType
}
